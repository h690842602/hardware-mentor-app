...
Please set the JAVA_HOME variable in your environment to match the
location of your Java installation, or install a JDK that contains Java."
fi
...
IFS=$'\n'
# *
#  *  Collect all arguments and run the app
#  *
GRADLE_OPTS="$GRADLE_OPTS \"-Dorg.gradle.appname=$APP_BASE_NAME\""

# *
#  *  By default we want the default JVM settings
#  *
if [ "$GRADLE_OPTS" = "" ] ; then
